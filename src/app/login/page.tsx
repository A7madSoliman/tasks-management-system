...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[#f9f9ff] text-[#041b3c]">
      ...
      <div
        className="pointer-events-none absolute bottom-0 right-0 overflow-hidden p-[48px] opacity-40"
        aria-hidden="true"
      >
        <div className="relative size-[256px]">
          <div className="absolute inset-0 rounded-[12px] bg-[rgba(0,82,204,0.2)] blur-[50px]" />
          <div className="absolute left-1/2 top-1/2 size-[128px] -translate-x-1/2 -translate-y-1/2 rounded-[12px] border border-[rgba(0,61,155,0.1)]" />
        </div>
      </div>

      {/* Header - Top Navigation (Reduced for Focused Login State) matching Figma nodes 1:356 / 1:342 */}
      <header className="flex h-[64px] w-full shrink-0 items-center justify-between px-[24px] bg-[rgba(249,249,255,0.8)] backdrop-blur-[6px] md:h-[80px] md:bg-[#f9f9ff] md:backdrop-blur-none md:px-[40px]">
        <div className="flex items-center gap-[8px]">
          ...
          <span className="text-[20px] font-bold leading-[28px] tracking-[-0.5px] text-[#041b3c]">
            TASKLY
          </span>
        </div>
      </header>
      ...
      <main className="relative flex flex-1 items-center justify-center px-[24px] py-[40px] md:py-[80px]">
        <div className="w-full max-w-[384px] md:max-w-[480px] md:rounded-[8px] md:bg-white md:p-[48px] md:drop-shadow-[0px_24px_24px_rgba(4,27,60,0.06)]">
          ...
          <div className="mb-[24px] text-center">
            <h1 className="text-[24px] font-semibold leading-[32px] tracking-[-0.6px] text-[#041b3c] md:text-[30px] md:leading-[36px] md:tracking-[-0.75px]">
              Welcome Back
            </h1>
